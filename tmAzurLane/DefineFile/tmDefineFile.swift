...
// 判断系统版本
func kIS_IOS7() ->Bool { (UIDevice.current.systemVersion as NSString).doubleValue >= 7.0 }
func kIS_IOS8() -> Bool { (UIDevice.current.systemVersion as NSString).doubleValue >= 8.0 }
